...
#Bot token @Botfather
TELEGRAM_TOKEN = os.environ.get("TELEGRAM_TOKEN", "7848802187:AAHB57UFUFv0fRR_htevJhsmDT5hf-rfknE")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002176591513"))
...
DB_NAME = os.environ.get("DATABASE_NAME", "AnimeNewsQuest")
